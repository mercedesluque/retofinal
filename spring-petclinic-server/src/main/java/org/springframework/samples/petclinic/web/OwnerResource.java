...
public class OwnerResource extends AbstractResourceController {
    ...
    public Owner login(@RequestParam("email") String email, @RequestParam("password") String password) {
        return this.clinicService.login(email, password);
    }
    
    @RequestMapping(value = "/owner/login", method = RequestMethod.GET)
    public Owner login2(@RequestParam("email") String email, @RequestParam("password") String password) {
        return this.clinicService.login(email, password);
    }
